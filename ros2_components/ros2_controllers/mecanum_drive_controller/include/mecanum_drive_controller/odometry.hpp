...
#include "mecanum_drive_controller/rolling_mean_accumulator.hpp"
...
private:
  using RollingMeanAccumulator =
    mecanum_drive_controller::RollingMeanAccumulator<double>;

  void integrateRungeKutta2(double linear, double angular);
  void integrateExact(double dx, double dy, double da);
  ...
  RollingMeanAccumulator linearx_accumulator_;
  RollingMeanAccumulator lineary_accumulator_;
